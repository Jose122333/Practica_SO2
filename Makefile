...
SOURCES=bloques.c ficheros_basicos.c mi_mkfs.c leer_sf.c ficheros.c escribir.c leer.c stat_chmod.c directorios.c test_trunk.c mi_mkdir.c mi_chmod.c mi_stat.c mi_ln.c mi_ls.c mi_escribir.c mi_cat.c mi_rm.c simulacion.c
...
PROGRAMS=mi_mkfs leer_sf escribir leer stat_chmod test_trunk mi_mkdir mi_chmod mi_stat mi_ln mi_ls mi_escribir mi_cat mi_rm simulacion
OBJS=$(SOURCES:.c=.o)
