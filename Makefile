SOURCES=bloques.c ficheros_basicos.c my_mkfs.c leer_SF.c ficheros.c escribir.c leer.c stat_chmod.c directorios.c test_trunk.c
...
PROGRAMS=my_mkfs leer_SF escribir leer stat_chmod test_trunk
OBJS=$(SOURCES:.c=.o)
